 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.19.1/apps/PB-TC/esp32/build_contexts/build_ctx_323115145/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.19.1/apps/PB-TC/esp32/build_contexts/build_ctx_323115145/build/gen/mos_conf_schema.yml
 */
...
static const struct mgos_conf_entry mgos_config_schema_[] = {
    ...
    {.type = CONF_TYPE_OBJECT, .key = "potbot", .offset = offsetof(struct mgos_config, potbot), .num_desc = 10},
    {.type = CONF_TYPE_STRING, .key = "name", .offset = offsetof(struct mgos_config, potbot.name)},
    {.type = CONF_TYPE_INT, .key = "exFanPin", .offset = offsetof(struct mgos_config, potbot.exFanPin)},
    {.type = CONF_TYPE_INT, .key = "inFanPin", .offset = offsetof(struct mgos_config, potbot.inFanPin)},
    {.type = CONF_TYPE_INT, .key = "watPin", .offset = offsetof(struct mgos_config, potbot.watPin)},
    {.type = CONF_TYPE_INT, .key = "lightPin", .offset = offsetof(struct mgos_config, potbot.lightPin)},
    {.type = CONF_TYPE_INT, .key = "dhtPin", .offset = offsetof(struct mgos_config, potbot.dhtPin)},
    {.type = CONF_TYPE_INT, .key = "lightTime", .offset = offsetof(struct mgos_config, potbot.lightTime)},
    {.type = CONF_TYPE_INT, .key = "fanTime", .offset = offsetof(struct mgos_config, potbot.fanTime)},
    {.type = CONF_TYPE_INT, .key = "waterTime", .offset = offsetof(struct mgos_config, potbot.waterTime)},
    {.type = CONF_TYPE_BOOL, .key = "metric", .offset = offsetof(struct mgos_config, potbot.metric)},
};
...
const struct mgos_conf_entry *mgos_config_i2c_get_schema(void) {
  return &mgos_config_schema_[176];
}
...
const struct mgos_conf_entry *mgos_config_board_led1_get_schema(void) {
  return &mgos_config_schema_[190];
}
...
const struct mgos_conf_entry *mgos_config_board_btn1_get_schema(void) {
  return &mgos_config_schema_[199];
}
...
const struct mgos_conf_entry *mgos_config_board_btn3_get_schema(void) {
  return &mgos_config_schema_[205];
}
...
const struct mgos_conf_entry *mgos_config_potbot_get_schema(void) {
  return &mgos_config_schema_[208];
}

void mgos_config_potbot_set_defaults(struct mgos_config_potbot *cfg) {
  cfg->name = "PotBot";
  cfg->exFanPin = 21;
  cfg->inFanPin = 19;
  cfg->watPin = 4;
...
void mgos_config_set_defaults(struct mgos_config *cfg) {
  ...
  mgos_config_potbot_set_defaults(&cfg->potbot);
}
...
int mgos_config_get_default_provision_led_pin(void) { return 2; }
...
const char * mgos_config_get_default_wifi_ap_ssid(void) { return "PotBot_????"; }
...
/* potbot */
const struct mgos_config_potbot *mgos_config_get_potbot(const struct mgos_config *cfg) { return &cfg->potbot; }

/* potbot.name */
const char * mgos_config_get_potbot_name(const struct mgos_config *cfg) { return cfg->potbot.name; }
const char * mgos_config_get_default_potbot_name(void) { return "PotBot"; }
void mgos_config_set_potbot_name(struct mgos_config *cfg, const char * v) { mgos_conf_set_str(&cfg->potbot.name, v); }

/* potbot.exFanPin */
int mgos_config_get_potbot_exFanPin(const struct mgos_config *cfg) { return cfg->potbot.exFanPin; }
int mgos_config_get_default_potbot_exFanPin(void) { return 21; }
void mgos_config_set_potbot_exFanPin(struct mgos_config *cfg, int v) { cfg->potbot.exFanPin = v; }

/* potbot.inFanPin */
int mgos_config_get_potbot_inFanPin(const struct mgos_config *cfg) { return cfg->potbot.inFanPin; }
int mgos_config_get_default_potbot_inFanPin(void) { return 19; }
void mgos_config_set_potbot_inFanPin(struct mgos_config *cfg, int v) { cfg->potbot.inFanPin = v; }

/* potbot.watPin */
int mgos_config_get_potbot_watPin(const struct mgos_config *cfg) { return cfg->potbot.watPin; }
int mgos_config_get_default_potbot_watPin(void) { return 4; }
void mgos_config_set_potbot_watPin(struct mgos_config *cfg, int v) { cfg->potbot.watPin = v; }

/* potbot.lightPin */
int mgos_config_get_potbot_lightPin(const struct mgos_config *cfg) { return cfg->potbot.lightPin; }
int mgos_config_get_default_potbot_lightPin(void) { return 18; }
void mgos_config_set_potbot_lightPin(struct mgos_config *cfg, int v) { cfg->potbot.lightPin = v; }

/* potbot.dhtPin */
int mgos_config_get_potbot_dhtPin(const struct mgos_config *cfg) { return cfg->potbot.dhtPin; }
int mgos_config_get_default_potbot_dhtPin(void) { return 22; }
void mgos_config_set_potbot_dhtPin(struct mgos_config *cfg, int v) { cfg->potbot.dhtPin = v; }

/* potbot.lightTime */
int mgos_config_get_potbot_lightTime(const struct mgos_config *cfg) { return cfg->potbot.lightTime; }
int mgos_config_get_default_potbot_lightTime(void) { return 0; }
void mgos_config_set_potbot_lightTime(struct mgos_config *cfg, int v) { cfg->potbot.lightTime = v; }

/* potbot.fanTime */
int mgos_config_get_potbot_fanTime(const struct mgos_config *cfg) { return cfg->potbot.fanTime; }
int mgos_config_get_default_potbot_fanTime(void) { return 0; }
void mgos_config_set_potbot_fanTime(struct mgos_config *cfg, int v) { cfg->potbot.fanTime = v; }

/* potbot.waterTime */
int mgos_config_get_potbot_waterTime(const struct mgos_config *cfg) { return cfg->potbot.waterTime; }
int mgos_config_get_default_potbot_waterTime(void) { return -1; }
void mgos_config_set_potbot_waterTime(struct mgos_config *cfg, int v) { cfg->potbot.waterTime = v; }

/* potbot.metric */
int mgos_config_get_potbot_metric(const struct mgos_config *cfg) { return cfg->potbot.metric; }
int mgos_config_get_default_potbot_metric(void) { return false; }
void mgos_config_set_potbot_metric(struct mgos_config *cfg, int v) { cfg->potbot.metric = v; }
